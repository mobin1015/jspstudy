...
public class DataBind3 extends HttpServlet {
     ...
     * 데이터 저장 영역
     * 
     * 1. ServletContext       : 컨텍스트 종료(애플리케이션 실행 종료) 전까지 데이터를 유지한다. // 몰라도됨
     * 2. HttpSession          : 세션 종료(웹 브라우저 종료) 전까지 데이터를 유지한다.           // 로그인할때 씀
     * 3. HttpServletRequest   : 요청 종료(응답) 전까지 데이터를 유지한다.                       // 70 ~80는 이거 씀
     */
